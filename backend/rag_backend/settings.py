...
if not DEBUG:
    ...
    # Explicitly disable SSL redirect in development
...
# If OLLAMA_BASE_URL is not set and API key is provided, use Ollama Cloud
# Otherwise default to local instance
if OLLAMA_API_KEY and not os.getenv('OLLAMA_BASE_URL'):
    OLLAMA_BASE_URL = 'https://ollama.com'  # Ollama Cloud
else:
    OLLAMA_BASE_URL = os.getenv('OLLAMA_BASE_URL', 'http://localhost:11434')
OLLAMA_MODEL = os.getenv('OLLAMA_MODEL', 'deepseek-v3.1:671b-cloud')
# Use Ollama if OLLAMA_API_KEY is set, otherwise fall back to Gemini
USE_OLLAMA = bool(OLLAMA_API_KEY) or os.getenv('USE_OLLAMA', 'false').lower() == 'true'
