...
- **Ollama** (recommended): `OLLAMA_API_KEY`, `OLLAMA_BASE_URL`, `OLLAMA_MODEL`, `USE_OLLAMA=true`
- **Gemini**: `GEMINI_API_KEY`

See `.env.example` for a complete example. For Ollama setup, see `OLLAMA_SETUP.md`.
