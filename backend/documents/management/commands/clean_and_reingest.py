    ...
    def reingest_pdfs(self, generate_summaries=False, summary_length=1500):
        ...
        for pdf_file in pdf_files:
            try:
                ...
                # Note: This command doesn't have clerk_user_id, so chunks won't have user filtering
                # This is for legacy re-ingestion only
                success = chromadb_service.add_document_chunks(
                    document_id,
                    chunks,
                    clerk_user_id=None  # Legacy documents don't have user ID
                )
