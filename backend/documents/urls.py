...
urlpatterns = [
    ...
    path('docs/scrape/', views.scrape_website, name='scrape_website'),  # Scrape website endpoint
    ...
    path('docs/<str:document_id>/generate-quiz/', views.generate_quiz, name='generate_quiz'),
    path('docs/<str:document_id>/generate-notes/', views.generate_notes, name='generate_notes'),
    path('docs/<str:document_id>/generate-flashcards/', views.generate_flashcards, name='generate_flashcards'),
    path('docs/<str:document_id>/quiz/', views.get_quiz, name='get_quiz'),
    path('docs/<str:document_id>/notes/', views.get_notes, name='get_notes'),
    path('docs/<str:document_id>/flashcards/', views.get_flashcards, name='get_flashcards'),
    path('docs/ingestion-status/', views.get_ingestion_status, name='get_ingestion_status'),  # Ingestion status endpoint
    ...
    path('chat/conversations/default/', views.get_or_create_default_conversation, name='get_or_create_default_conversation'),
